...
UCLASS()
class MEGABONKCLONE_API UUpgradeSlotWidget : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	void SetSlotInfo(const FRewardOption& Info, int32 InSlotIndex);
...
protected:
	...
	UPROPERTY(meta = (BindWidget))
	TObjectPtr<UTextBlock> Next = nullptr;
